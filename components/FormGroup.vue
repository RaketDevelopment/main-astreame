...
<template>
  <div :class="props.classes">
    ...
    <p
      ...
      class="flex items-center mt-[4px] text-red-500">
      ...
      <span class="ml-[8px] text-[.754rem]">
        {{ props.errorMessage }}
      </span>
    </p>
    <p
      v-if="props.helpMessage && !props.errorMessage"
      class="mt-[4px] text-charcoal-700 text-[.754rem]">
        {{ props.helpMessage }}
    </p>
  </div>
</template>